...
In this project,we learnt about using arithmetic, logical, relational, and boolean operators in C. Additionally, we practiced declaring and defining variables of type char, int, and unsigned int, using if and if...else statements, and implementing while loops.
