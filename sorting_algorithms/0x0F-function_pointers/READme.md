...
3-get_op_func.c: C function that selects the correct function from 3-op_functions.c  of 100.
...
If the number of arguments is incorrect, the program prints Error followed by a new line and exits with a status value of 2.to perform the operation asked by the user.
...
If the user tries to divide (/ or %) by 0, the program prints Error followed by a new line and exits with a status value
